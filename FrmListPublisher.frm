...
Begin VB.Form FrmListPublisher 
   ...
   End
End
Attribute VB_Name = "FrmListPublisher"
...
If dgv.VisibleRows > 0 Then
    dgv.Col = 0
    bll.DeletePublisher (dgv.text)
    LoadGrid
End If
End Sub

Private Sub btnNew_Click()
Dim createUpdate As New FrmCreateUpdatePublisher
...
Private Sub dgv_DblClick()
    If dgv.VisibleRows > 0 Then
        Dim update As New FrmCreateUpdatePublisher
        dgv.Col = 0
...
Set dgv.DataSource = bll.GetPublishers(txtCode.text, txtName.text, cboStatus.text)
